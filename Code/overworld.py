...
from groups import WorldSprties
...
class Overworld:
    def __init__(self, tmx_map, data, overworld_frames, switch_stage):
        ...
        #groups
        self.all_sprites = WorldSprties(data)
        ...
        self.keybinds_ui.update_keybinds(overworld_keybinds)
        self.keybinds_ui.set_position("bottom-right") 
